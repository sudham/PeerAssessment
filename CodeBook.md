...
The complete list of variables of each feature vector is available in the files:
...
- 'train/X_train.txt': Training set containing the measures for the feature set.

- 'train/y_train.txt': Training labels indicating the activity for which the measurement is taken.

- 'test/X_test.txt': Test set - as above.

- 'test/y_test.txt': Test labels - as above.

- 'train/subject_train.txt': Each row identifies the subject who performed the activity for each window sample. Its range is from 1 to 30. 
- 'test/subject_train.txt': as above
...
The extracted measurements for mean and standard deviation
